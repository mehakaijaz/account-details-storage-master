...
def onsubmit():
    ...
    messagebox.showinfo('Input Your Details', 'Successfully Added, \n' + 'Account Name: ' + n + '\nUsername: ' + m + '\nPassword: ' + p)
    readfile()
...
entity_label = Label(window, text='Add Confidential Data', font=('Courier', 18))
name_label = Label(window, text='Account Name: ', font=('Courier', 14))
...
submit = Button(window, text='Add Details', command=onsubmit, font=('Courier', 14))
...
name_label2 = Label(window, text='Account Name: ', font=('Courier', 14))
